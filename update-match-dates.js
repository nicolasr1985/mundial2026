// update-match-dates.js
// Run with: node update-match-dates.js
// Requires: npm install firebase-admin
// Place your Firebase service account key as "serviceAccount.json" in the same folder
...
// All group stage matches with correct Bogota times (UTC-5)
// Converted from official ICS feed
const CORRECT_TIMES = [
  // GRUPO A
  ...
  { home: "Canada", away: "Switzerland", date: "2026-06-18T14:00:00-05:00" },  // app shows wrong
  { home: "Qatar", away: "Bosnia and Herzegovina", date: "2026-06-18T17:00:00-05:00" },
  { home: "Bosnia and Herzegovina", away: "Switzerland", date: "2026-06-24T14:00:00-05:00" },
  ...
  { home: "Iraq", away: "Senegal", date: "2026-06-22T19:00:00-05:00" },
  { home: "France", away: "Norway", date: "2026-06-22T16:00:00-05:00" },
  { home: "France", away: "Iraq", date: "2026-06-27T16:00:00-05:00" },  // app says 9pm
  { home: "Senegal", away: "Norway", date: "2026-06-27T16:00:00-05:00" },
  // GRUPO J
  ...
  // GRUPO K
  { home: "Colombia", away: "Congo DR", date: "2026-06-17T12:00:00-05:00" },
  { home: "Portugal", away: "Uzbekistan", date: "2026-06-17T21:00:00-05:00" },
  { home: "Congo DR", away: "Uzbekistan", date: "2026-06-23T12:00:00-05:00" },
  { home: "Portugal", away: "Colombia", date: "2026-06-23T15:00:00-05:00" },
  ...
  { home: "England", away: "Panama", date: "2026-06-27T16:00:00-05:00" },
  // Extra matches from ICS
...
async function updateMatches() {
  ...
  for (const entry of CORRECT_TIMES) {
    const match = snapshot.docs.find(
      (d) =>
        d.data().homeTeam === entry.home &&
        d.data().awayTeam === entry.away
    );
    ...
    console.log(`✅ Updated: ${entry.home} vs ${entry.away} → ${newDate.toISOString()}`);
    updated++;
  }
