...
export const FIFA_RANKINGS: FifaEntry[] = [
  ...
  { rank: 13, name: "Mexico", code: "MEX" },
  { rank: 14, name: "Colombia", code: "COL" },
  { rank: 15, name: "United States", code: "USA" },
  { rank: 16, name: "Senegal", code: "SEN" },
  { rank: 17, name: "Uruguay", code: "URU" },
  { rank: 18, name: "Japan", code: "JPN" },
  { rank: 19, name: "Switzerland", code: "SUI" },
  { rank: 20, name: "Iran", code: "IRN" },
  { rank: 21, name: "Denmark", code: "DEN" },
  { rank: 22, name: "South Korea", code: "KOR" },
  { rank: 23, name: "Turkey", code: "TUR" },
  { rank: 24, name: "Ecuador", code: "ECU" },
  { rank: 25, name: "Austria", code: "AUT" },
  { rank: 26, name: "Nigeria", code: "NGA" },
  { rank: 27, name: "Australia", code: "AUS" },
  { rank: 28, name: "Algeria", code: "ALG" },
  { rank: 29, name: "Egypt", code: "EGY" },
  { rank: 30, name: "Norway", code: "NOR" },
  { rank: 31, name: "Canada", code: "CAN" },
  ...
  { rank: 39, name: "Hungary", code: "HUN" },
  { rank: 40, name: "Scotland", code: "SCO" },
  { rank: 41, name: "Serbia", code: "SRB" },
  { rank: 42, name: "Paraguay", code: "PAR" },
  { rank: 43, name: "Czechia", code: "CZE" },
  { rank: 44, name: "Cameroon", code: "CMR" },
  { rank: 45, name: "Tunisia", code: "TUN" },
  { rank: 46, name: "Congo DR", code: "COD" },
  { rank: 47, name: "Slovakia", code: "SVK" },
  { rank: 48, name: "Greece", code: "GRE" },
  { rank: 49, name: "Venezuela", code: "VEN" },
  { rank: 50, name: "Qatar", code: "QAT" },
  { rank: 51, name: "Uzbekistan", code: "UZB" },
  { rank: 52, name: "Chile", code: "CHI" },
  { rank: 53, name: "Peru", code: "PER" },
  { rank: 54, name: "Romania", code: "ROU" },
  { rank: 55, name: "Mali", code: "MLI" },
  { rank: 56, name: "Costa Rica", code: "CRC" },
  { rank: 57, name: "Iraq", code: "IRQ" },
  { rank: 58, name: "Slovenia", code: "SVN" },
  { rank: 59, name: "Republic of Ireland", code: "IRL" },
  { rank: 60, name: "Saudi Arabia", code: "KSA" },
  { rank: 61, name: "South Africa", code: "RSA" },
  { rank: 62, name: "Burkina Faso", code: "BFA" },
  { rank: 63, name: "Bosnia and Herzegovina", code: "BIH" },
  { rank: 64, name: "Jordan", code: "JOR" },
  { rank: 65, name: "Honduras", code: "HON" },
  { rank: 66, name: "Albania", code: "ALB" },
  { rank: 67, name: "United Arab Emirates", code: "UAE" },
  { rank: 68, name: "Cape Verde", code: "CPV" },
  ...
  { rank: 88, name: "Angola", code: "ANG" },
  { rank: 89, name: "Uganda", code: "UGA" },
  { rank: 90, name: "Zambia", code: "ZAM" },
  { rank: 91, name: "China PR", code: "CHN" },
  { rank: 92, name: "Bahrain", code: "BHR" },
  { rank: 93, name: "Benin", code: "BEN" },
