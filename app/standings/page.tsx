    ...
    <div>
      ...
      <div ref={scrollRef} style={{ overflowX: "auto", overflowY: "hidden", paddingBottom: 8, WebkitOverflowScrolling: "touch", maxWidth: "100vw" } as React.CSSProperties}>
        <div style={{ display: "flex", gap: 0, alignItems: "stretch" }}>
          ...
          <div style={{ position: "relative", width: "max-content", minWidth: 150, flex: "0 0 auto", alignSelf: "stretch", paddingLeft: 32 }}>
            <div style={{ position: "absolute", top: "50%", left: 32, right: 0, transform: "translateY(-50%)" }}>
...
const GOAL_SCORERS_DATA: GoalScorer[] = [
  ...
  { player: "Breel Embolo", country: "Switzerland", code: "SUI", goals: 2 },
  ...
  { player: "Dan Ndoye", country: "Switzerland", code: "SUI", goals: 2 },
  ...
  { player: "Neymar", country: "Brazil", code: "BRA", goals: 1 },
...
const PICK_TO_GOALS: Record<string, number> = {
  ...
  "(CIV) Diallo, Amad": 2,
  "(CIV) Pépé, Nicolas": 2,
  "(MEX) Quiñones, Julián": 4,
  "(MEX) Quinones, Julian": 4,
  "(NED) Summerville, Crysencio": 2,
  "(POR) Ronaldo, Cristiano": 3,
  "(ESP) Oyarzabal, Mikel": 5,
  "(ESP) Oyarzabal Ugarte, Mikiel": 5,
